...
public class AlloyFurnaceScreen extends HandledScreen<ScreenHandler> {
    private static final Identifier TEXTURE = new Identifier("ag", "textures/gui/container/alloy_furnace.png");

    public AlloyFurnaceScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
