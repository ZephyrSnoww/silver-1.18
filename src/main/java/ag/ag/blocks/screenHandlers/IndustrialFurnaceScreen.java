...
public class IndustrialFurnaceScreen extends HandledScreen<ScreenHandler> {
    private static final Identifier TEXTURE = new Identifier("ag", "textures/gui/container/industrial_furnace.png");

    public IndustrialFurnaceScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
