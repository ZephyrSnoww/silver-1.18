...
public class AgClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ScreenRegistry.register(Ag.INDUSTRIAL_FURNACE_SCREEN_HANDLER, IndustrialFurnaceScreen::new);
        ScreenRegistry.register(Ag.ARC_FURNACE_SCREEN_HANDLER, ArcFurnaceScreen::new);
    }
}
